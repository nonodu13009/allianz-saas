...
const firebaseConfig = {
  ...
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || "allianz-saas-132c3.firebaseapp.com",
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || "allianz-saas-132c3",
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "allianz-saas-132c3.appspot.com",

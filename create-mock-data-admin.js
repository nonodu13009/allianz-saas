 ...
 * Utilise Firebase Admin SDK pour créer 15 activités en septembre 2025
 */
  ...
  try {
    ...
    mockActivities.forEach((activity, index) => {
      ...
      const activityData = {
        ...activity,
        primePonderee,
        userId: 'jxRt3ZzCVqYVZ9aYd8Tu4I5ymu13', // Karen Chollet
        month: '2025-09',
        createdAt: admin.firestore.FieldValue.serverTimestamp(),
        updatedAt: admin.firestore.FieldValue.serverTimestamp()
      };

      console.log(`📝 Préparation activité ${index + 1}/15: ${activity.nomClient}`);
    ...
    console.log('💾 Sauvegarde en batch dans Firestore...');
    await batch.commit();
    
    console.log('✅ Toutes les activités mock ont été créées avec succès !');
    console.log(`📋 15 documents créés dans la collection sante_coll_activities`);
    ...
    console.log('2. Allez sur /dashboard');
